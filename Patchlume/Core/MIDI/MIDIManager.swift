...
/// of Modula's `MIDIManager` packet-walking approach, renamed for Patchlume.
@MainActor
final class MIDIManager: ObservableObject {
    ...
    private func setUpCoreMIDI() {
        let clientStatus = MIDIClientCreateWithBlock("PatchlumeMIDIClient" as CFString, &client) { [weak self] _ in
            Task { @MainActor in
        ...
        let portStatus = MIDIInputPortCreateWithBlock(client, "PatchlumeInputPort" as CFString, &inputPort) { [weak self] packetList, _ in
